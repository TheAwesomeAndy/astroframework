...
assert.equal(a.nulls.tests.length,13);assert.equal(a.nulls.interpretation_status,'withheld');assert.equal(a.nulls.population_frequency_status,'not_measured');assert.equal(a.candidate_nulls.length,a.discovery.candidates.length);assert.deepEqual(a.nulls.tests.map(t=>t.null_distribution_summary.digest),b.nulls.tests.map(t=>t.null_distribution_summary.digest));
